    ...
    r.isNull)
      ...
      , k = function(o) {
        ...
        a(r, [{
            ...
            value: function() {
                this.attrNormalize(),
                this.set.range > 0 && (this.positionX = l() * this.cw,
            ...
            value: function() {
                ...
                this.dots.forEach(function(o) {
                    if (!e) {
                        ...
                        c += p,
                        u += v,
                        c + h >= n ? o.vx = -f(o.vx) : c - h <= 0 && (o.vx = f(o.vx)),
                        u + h >= a ? o.vy = -f(o.vy) : u - h <= 0 && (o.vy = f(o.vy))
                    }
                })
            }
        }, {
            ...
            value: function(e, t) {
                ...
                var r = function(t) {
                    if (!i.paused) {
                        var o = t.pageX
                          , r = t.pageY;
                        i.setElemOffset() && (n(a, "position", "fixed") && (o = t.clientX,
                        r = t.clientY),
                        o -= i.elemOffset.left,
                        r -= i.elemOffset.top),
                        e(o, r)
